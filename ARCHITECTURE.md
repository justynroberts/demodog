...
Why DemoDog is built the way it is — the decisions that are not obvious from
reading the code, and the ones that were arrived at by getting them wrong first.
